    ...
    <div>
      ...
      <div class="mb-8 text-center">
        <div class="text-body-medium font-weight-light mb-n1">
          Sistema Template VUE3 + Vuetify
        </div>
        <div class="text-display-medium font-weight-bold">Templave VUETiFY</div>
      </div>
      ...
      <v-row>
        <v-col cols="12">
          ...
          >
            ...
            <template #title>
              <div
                class="my-title my-uppercase text-headline-medium font-weight-bold"
              >
                Get started
              </div>
            </template>
